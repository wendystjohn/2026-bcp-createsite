...
In this investigation, you will be introduced to several typical ways that biological datasets - both experimental and observational - can be assessed using open source statistical tools. You will use **Python** to analyze thousands of wildlife observations collected through **iNaturalist**, a global community science project. As you explore the data, you'll learn to organize information, create visualizations, and evaluate ecological patterns using the same computational tools employed by professional scientists.
...
This activity runs entirely in your web browser using **JupyterLite** [JupyterLab](https://jupyter.org/), so no software installation is required.

[JupyterLite](https://github.com/jupyterlite/jupyterlite) is an open-source web application that allows users to combine code, text, figures, and notes into a single interactive notebook where you can document your investigation as you work. 
...
[Python](https://www.python.org), one of the world's most widely used programming languages. It has become a standard tool for scientific computing, data analysis, visualization, and research. We will use Python to write instructions that the computer can follow. No previous programming experience is required for this activity.
...
Pandas is a Python library designed for organizing and analyzing tabular data. [Pandas](https://pandas.pydata.org/) helps you load, view, filter, organize, and summarize data.
...
*[https://wendystjohn.github.io/2026-bcp-createsite/lab/]([https://wendystjohn.github.io/2026-bcp-createsite/lab/](https://wendystjohn.github.io/2026-bcp-createsite/lab/notebooks/index.html?path=BiodiversityBiasBigData.ipynb))*
